...
### Fixed
 ...
 - Форма повторной аутентификации теперь отображает поле Email с предзаполненным значением (#11).
 - Исправлена повторная аутентификация для пользователей, обновившихся с версии 1.x — unique_id config entry обновляется с номера лицевого счёта на email.
 - Удалена проверка `_abort_if_unique_id_mismatch` из reauth flow, которая блокировала переавторизацию мигрированных записей.
